...
class DrainageComplainRA : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_drainage_complain_ra)

        userRecyclerView = findViewById(R.id.ComplainBookDrainage)
    ...
    private fun getUserData() {
        dbref = FirebaseDatabase.getInstance().getReference("Complains/Drainage")
