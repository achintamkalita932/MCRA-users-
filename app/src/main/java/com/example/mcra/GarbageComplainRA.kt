...
class GarbageComplainRA : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_garbage_complain_ra)

        userRecyclerView = findViewById(R.id.ComplainBookGarbage)
    ...
    private fun getUserData() {
        dbref = FirebaseDatabase.getInstance().getReference("Complains/Garbage")
